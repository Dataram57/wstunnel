...
| `SWTCP_2_SOCK5` | `interface_SWTCP_2_SOCK5.js` <br> Configure: `config_SWTCP_2_SOCK5.json` | `client_SWTCP/client_SWTCP_2.js` <br> Install: `ws` <br> Configure: `config.json` | Tunnels a pseudo SOCK5 server that can Handle UDP and TCP connections, using symmetric encryption |